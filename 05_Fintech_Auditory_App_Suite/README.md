...
3. **Medidas de Control Bidireccional (DAX):** Se parametrizaron cálculos avanzados en DAX para detectar diferencias decimales o descalces temporales entre registros:
